...
import perfilUsuariosRoutes from './routes/UsuariosRoutes.js';
...
// Rutas de ofertas, aplicaciones, dashboard y perfil de postulantes
app.use('/api', ofertasRoutes);
app.use('/api', aplicacionesRoutes);
app.use('/api', dashboardRoutes);
app.use('/api', perfilUsuariosRoutes);
